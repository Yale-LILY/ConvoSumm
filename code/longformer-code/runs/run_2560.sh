...
#MODEL_PATH="./bart-large-long-4096"
#python ./scripts/summarization_truncated.py \
#  --batch_size=1 \
#  --save_prefix=bart-large-long-4096-1-8-67-20-1024 \
#  --model_path=bart-large-long-4096 \
#  --gpus=8 \
#  --max_input_len=4096 \
#  --max_output_len=256 \
...
#  --warmup 20 \
#  --test \
#  --from_pretrained /private/home/alexfabbri/convosumm/Argument-Graph-Mining/longformer/summarization/bart-large-long-4096-1-8-67-20-1024/_ckpt_epoch_95.ckpt \
#  --attention_window 1024 ;
#  #--resume /private/home/alexfabbri/convosumm/Argument-Graph-Mining/longformer/summarization/bart-large-long-4096-1-8-67-20-1024/_ckpt_epoch_95.ckpt \
#  #--resume /private/home/alexfabbri/convosumm/Argument-Graph-Mining/longformer/summarization/bart-large-long-4096-1-8-67-20-1024/_ckpt_epoch_95.ckpt \

MODEL_PATH="./bart-large-long-4096"
python ./scripts/summarization_truncated.py \
  --batch_size=1 \
  --save_prefix=bart-large-long-4096-1-8-67-20-1024_actual \
  --model_path=bart-large-long-4096 \
  --gpus=8 \
  --max_input_len=4096 \
  --max_output_len=256 \
  ...
  --warmup 20 \
  --test \
  --from_pretrained /private/home/alexfabbri/convosumm/Argument-Graph-Mining/longformer/summarization/bart-large-long-4096-1-8-67-20-1024_actual/_ckpt_epoch_53.ckpt \
  --attention_window 1024 ;
  #--resume /private/home/alexfabbri/convosumm/Argument-Graph-Mining/longformer/summarization/bart-large-long-4096-1-8-67-20-1024/_ckpt_epoch_95.ckpt \
  #--resume /private/home/alexfabbri/convosumm/Argument-Graph-Mining/longformer/summarization/bart-large-long-4096-1-8-67-20-1024/_ckpt_epoch_95.ckpt \
